...
export const vehicles: Vehicle[] = [
  ...
  { id:"suv", slug:"suv", category:"Car", name:"SUV", seater:6, ac:true, features:["AC","Spacious","Charging Point","Luggage 3 Bags"], description:"Innova / Ertiga class. Extra space for luggage and longer rides.", pricing:{ perKm:18, driverPerDay:500, minKmPerDay:250, extraPerKm:18, taxPct:5 }, image:"https://images.unsplash.com/photo-1549399542-7e3f8b79c341?w=800&auto=format&fit=crop&q=60", imageAlt:"White Innova SUV — 6 seater" },
